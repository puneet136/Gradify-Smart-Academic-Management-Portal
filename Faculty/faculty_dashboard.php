...
// Prepare SQL query to fetch all broadcast messages for faculty
$sql = "SELECT message, attachment, sender_name, recipient_email, created_at 
        FROM broadcast_messages 
        WHERE sender_role = 'HOD' 
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td data-label="Recipient Email"><?= htmlspecialchars($row['recipient_email']); ?></td>
